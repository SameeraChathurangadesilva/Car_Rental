...
public class CustomerDTO {
    ...
    public CustomerDTO(String customerid, String title, String customername, String customeraddress, String customernicnumber, String customerEmailaddress, String customerTelephonenumber) {
